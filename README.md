...
**As of january 2020, this library will no longer be maintained, it is superseded by https://github.com/tiramiseb/go-gandi. Don't hesitate to make PRs bugfixes or security fixes though...**

This library interacts with [Gandi's LiveDNS API](http://doc.livedns.gandi.net/), to manage domains hosted on Gandi. This API returns some data as HTTP headers, please note those are ignored by this library.
